package com.xingzi.mikasamessage.dao;
...
public interface UserDao {
     ...
     * @return
     */
    public List<Friend> getFriendListByUserId(String userNum);
     ...
     * @return
     */
    List<ChatMessage> getMessageById(@Param("id") int id,@Param("friendId") int friendId);
