    ...
    <div class="wc__home-wrapper flexbox flex__direction-column">
        ...
        <div class="wc__headerBar fixed">
            <div class="inner flexbox">
                ...
                <h2 class="barTit flex1" id="test">微友圈</h2>
            </div>
        </div>
        ...
        <div class="wc__friendZone">
            ...
            <c:set var="nickname" scope="request" value="${user.nickname}"/>
            <!-- //列表区 -->
            <div class="cont">
                <div class="inner">
                    <ul class="wc__cmtlist clearfix" id="J__cmtList">
                        <c:forEach var="say" items="${sayList}">
                                                                    ...
                                                                    <c:set var="isone" value="1"></c:set>
                                                                        <c:forEach var="commentUser" items="${commentUserList}">
                                                                            ...
                                                                            <c:if test="${commentUser.userNum==p.userNum}">
                                                                                ...
                                                                                <p><span id="${commentUser.nickname}">${commentUser.nickname}:</span>${p.content}</p>
                                                                            </c:if>
                                                                            </c:if>
                                                                        </c:forEach>
                                                                </c:forEach>
...
<script type="text/javascript">
    function onLike(sayId) {
        ...
        var myname=$("#"+sayId+" span ").text();
        var a=myname.indexOf(nickname);
        if(a==-1){
            $.ajax({
                url: "like",
                ...
                success: function (data) {
                    if(data=="true"){
                        var flag= $("#"+sayId).val();
                        if (flag==""||flag==null){
                            $("#"+sayId).append("<span>"+nickname+"</span>");
                        }else{
                            $("#"+sayId).appendChild("<span>,</span>");
                            $("#"+sayId).appendChild("<span>"+nickname+"</span>");
                        }
                    }else{
                    }
                }
