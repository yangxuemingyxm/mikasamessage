    ...
    <div class="wc__chat-wrapper flexbox flex__direction-column">
        ...
        <div class="wc__headerBar fixed">
            <div class="inner flexbox">
                <a class="back splitline" href="index" ></a>
                <h2 class="barTit flex1">${friend.nickname}</h2>
                <a class="barIco u-one" href="javascript:;"></a>
            </div>
        </div>
        <c:set value="${user.userId}" var="userId" scope="request"/>
        <!-- //微聊消息上墙面板 -->
        <div class="wc__chatMsg-panel flex1">
            <div class="chatMsg-cnt">
                <ul class="clearfix" id="J__chatMsgList">
                    <li class="notice"><span>你已经添加了${friend.nickname}，现在可以开始聊天了。</span></li>
                    <c:if test="${messageList!=null}">
                        <c:forEach items="${messageList}" var="message">
                            <c:if test="${message.sendId==user.userId}">
                                <li class="me">
                                    <div class="content">
                                        <div class="msg">
                                                ${message.content}
                                    ...
                                    <a class="avatar"><img src="static/assets/img/uimg/${user.headPortrait}" /></a>
                                </li>
                            </c:if>
                            <c:if test="${message.sendId==friend.userId}">
                                <li class="others">
