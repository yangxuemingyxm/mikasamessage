    ...
    <div class="wc__home-wrapper flexbox flex__direction-column">
        ...
        <div class="wc__headerBar fixed">
            <div class="inner flexbox">
                <h2 class="barTit barTitLg flex1">微聊<em class="ff-ar"></em></h2>
                <a class="barIco add" href="javascript:;" id="J__topbarAdd"></a>
            </div>
        </div>
        <audio id="audio" src="static/assets/yinpin/tishiyin.mp3"></audio>
        <!-- //4个tabBar滑动切换 -->
                                        ...
                                        <c:forEach  var="friend" items="${friendMap}">
                                            ...
                                            <c:if test="${p==friend.initial}">
                                                <li id="${str}" routeUrl="toDanLiaoPage?friendId=${friend.userId}">
                                                    ...
                                                    <div class="row flexbox flex-alignc wc__material-cell">
                                                        <a href="toHaoYouXinXi?userNum=${friend.userNum}"> <img class="uimg" src="static/assets/img/uimg/${friend.headPortrait}" /></a>
                                ...
                                <ul class="clearfix">
                                    <li>
                                        <div class="item flexbox flex-alignc wc__material-cell" routeUrl="toweiyouquan">
                                            <img class="icon" src="static/assets/img/icon__explore-img01.png" /><span class="txt flex1">朋友圈</span><div class="notice wc__arr"></div>
                                        </div>
                                    </li>
                                    <%--<li>
                    ...
                    <div class="swiper-slide">
                        <div class="wc__scrolling-panel">
                            <div class="wc__ucenter-list" id="J__ucenterList">
                                <ul class="clearfix">
                                    <li>
                                        <div class="item flexbox flex-alignc wc__material-cell" routeUrl="togerenxinxi">
                                    ...
                                    <%--<li>
                                        <div class="item flexbox flex-alignc wc__material-cell" routeUrl="#">
                                            <img class="icon" src="&lt;%&ndash;<%=session.getServletContext().getRealPath("static/assets/img")%>&ndash;%&gt;static/assets/img/icon__uc-img01.png" /><span class="txt flex1">钱包</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="item flexbox flex-alignc wc__material-cell">
        ...
        <div class="wechat__tabBar">
            <div class="bottomfixed wc__borT">
                <ul class="flexbox flex-alignc wechat-pagination">
                    <li class="flex1 on"><i class="ico i1"><em class="wc__badge"></em></i><span>微聊</span></li>
...
<script type="text/javascript">
    var Swiper = new Swiper('.swiper-container',{
        ...
        paginationBulletRender: function (Swiper, index, className) {
            switch (index) {
                case 0:
                    name='<i class="ico i1"><em class="wc__badge"></em></i><span>微聊</span>';
                    break;
                case 1:
                    name='<i class="ico i2"></i><span>通讯录</span>';
                    break;
                case 2:
                    name='<i class="ico i3"></i><span>探索</span>';
                    break;
                case 3:
                ...
                switch (message.type) {
                    case 'subscribe': // 对方请求添加好友
                        ...
                        if (truthBeTold) {
                            ...
                            $.ajax({
                                url: "addFriend",
                                data: {"userNum":message.to,"friendNum":message.from},
                                type:"post",
                    ...
                    case 'subscribed': // 对方同意添加好友，已方同意添加好友
                        //alert(message.from+"同意你的好友申请并请求添加你为好友");
                        break;
            ...
            onTextMessage: function(message) {
                ...
                $.ajax({
                    ...
                    success: function (friend){
                        ...
                        var date1=timeStamp2String(new Date());
                        if (flag){
                            var $chatMsgList = $("#J__chatMsgList");
                            var html=messagestr.replace('<p>','');
                            var htmlstr=html.replace('</p>','');
                            htmlstr=htmlstr.trim();
                            $("#time"+friendId).replaceWith("<label class='time' id='time${friend.userNum}'>"+date1+"</label>");
                            ...
                            <p class="desc clamp1 "id="str'+friend.userNum+'">'+messagestr+'</p>\
                              ...
                              <label class="time" id="time${users.userNum}">'+date1+'</label>\
                          </li>'].join("");
                            ul.append(html);
               ...
               alert("你收到了"+message.from+"的新消息，请及时查看!");
